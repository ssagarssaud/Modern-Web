    ...
    return (
        <section className="py-24">
            <div className="container">
                ...
                <div className="flex flex-col mt-16 gap-6 max-w-xl mx-auto">
                            ...
                            >
                                <div className="flex justify-between items-center">
                                    ...
                                    <svg
                                        ...
                                        className={twMerge("feather feather-plus flex-shrink-0 text-lime-400", selectedIndex===faqIndex && "rotate-45")}
                                    >
                                        <line
                                            x1="12"
                                            y1="5"
